...
if (isset($_GET['post-slug'])) {$postaut = getPost($_GET['post-slug']);}
require_once($head);
?>
<body>
<div class="page">
...
if (!empty($postaut['profile_pic'])) {echo "<img class=\"segment\" src=\"/assets/images/profile/".$postaut['profile_pic']."\" width=\"250\"/>";
}else{echo "<img src=\"/assets/images/testcard.jpeg\" width=\"250\"/>";}
?>
</div>
...
<p>".$postaut['name']." has not got a profile yet - they are probably quite shy.</p>

<p>See below for the fabulous recipes they have uploaded and let their food do the talking! </p>

<p>Or if you don't see anything you like, search away for more recipes.</p>
";
}
?>
<hr />
