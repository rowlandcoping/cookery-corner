...
<p>The rambling thoughts of a diseased <br>(yet inspired) lunatic.</p>
</div>
<!--section3-->
<div class="section">
	
	<a href="/reviews.php"><img src="/assets/banners/reviewstitle.png" width="210", height="50" /></a>
	<p>Rowland reviews things that no reviewer has ever dared review before. </p>
</div>
<!--section4: TBC!!!
<div class="section">
	
	<img src="/assets/banners/reviewstitle.png" width="210", height="50" />
	<p>When none of the other sections will do, Rowland has to put it somewhere.</p>
</div>-->
				</div>
			</div>
			...
			<p>Not registered yet? <a href="/register_user.php" target="blank">Get involved!</a>
			<br />Forgot Password? <a href="/reset_password.php" target="blank">No Problem!</a></p>
			<?php
			}else{?> <h2>Welcome to the party<br><?php echo $_SESSION['name'];?></h2>
					<h3>Are you here for a good time...
					<br>...or are you just passing through?</h3>
			...
			<p>So glad you could stop by!  I've been, uh, redecorating.</p> 

			<p>Here you will find recipes, cookery tips, fun features and even a very badly written blog by site
			progenitor <a href="/author/rowland-coping">Rowland Coping</a> himself.</p>

			<p>It's not a cult of personality any more though, because soon you can all add your favourite recipes and tell Rowland how bad his are too! 
			</p>
			<p>Not yet mind.  But you can sign up though and get all ready for it.</p>

			</div>

			<div class="recommends">
			<h3>Rowland Recommends... <a href="/reviews/exotic-meat-review">Exotic Meat Review</a></h3>
			<p>It's like 'My Family and Other Animals', except everything is dead and has been minced into sausages.</p>
...
<hr>
<div class="footseg2">
<p>Disclaimer: Cookery Corner accepts no responsibility for phsical and/or mental damage caused by the adoption or adaptation of its cookery tips.</p>

<p>This website is meant to be FUN, yet it is the work of but one man and sometimes things slip through the net.
<br>Any issues regarding the material herein should be addressed directly to the site owner via the contact page.</p>
</p>
</div>
<div class="footseg1">
<p><a href="/contactform.php" target="blank">Contact Us</a></p>
</div>
