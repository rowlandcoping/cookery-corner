<?php if(!isset($_SESSION)){session_start();}
    ...
    if (isset($_GET['post-slug'])) {
        $postcuis = getPost($_GET['post-slug']);	
    }
...
<html lang="en">
    <?php require_once($head); ?>
        <div class="page">
            ...
            <div class="maingen">	
                <div class="general">
                    <h1><?php echo ($cuisine);?> Cuisine</h1>
                    <div class="imgright">
                        <?php
                            $cuisine= $postcuis['cuisine'];
                    ...
                    <div class="gentext">                        
                        <?php
                            if (empty($postcuis['description'])) {
                                echo
                                    "<p>
                                        Here's some extremely interesting text telling you about how great ".$cuisine. " cuisine is but without actually
                                        going into any detail about what is so amazing about ".$cuisine." food in particular.
                                    </p>
                                    <p>
                                        This is on the grounds I have no idea what type of food I'm supposed to be referring to as yet. 
                                        There's a lot of this sort of stuff on the internet though, so I reckon nobody will notice.
                                    </p>
                                    <p>
                                        Because this is a generic placeholder, you'll have to trust me when I say that ".$cuisine." food is really tasty, 
                                        and accept any recipes you find on this page as excellent examples of why.
                                    </p>
                                    <p>
                                        This will do until the next update in about 5 years, don't you think?
                                    </p>"
                                ;
                ...
                <div class="first">                    
                    <?php
                        //displays recipes of selected cuisine for current page
