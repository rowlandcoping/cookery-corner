...
<p><b>Add Cuisine Type</b></p>
<div class=section1>
<form action="/admin/includes/cuisine_actions.php" method="POST" enctype="multipart/form-data">

<p><label for="form"><span style="color:red">*</span> Add Cuisine Type<br /><input type="text"  name="cuisine" required/>
</p>
