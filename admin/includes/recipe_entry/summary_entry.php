<?php
$stmt=$conn->prepare("SELECT user_ID, title, titslug, conclusion, stage FROM recipes WHERE ID=?");
...
<div class=section3>
	<h2>Stage 7 of 8 - Summary - <?php echo "<a href=\"/recipe/".$slug."\" target=\"_blank\">".$title."</a></h2>";?></h2>
	<div class=regular>
...
echo"<label for=\"submit-summary\"><input type=\"submit\" class=\"button\" name=\"submit-summary\" value=\"Update Section\" />";}
?>
</form>
</div>
</div>
