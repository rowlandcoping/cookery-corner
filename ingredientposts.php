...
if (isset($_GET['post-slug'])) {$posting = getPost($_GET['post-slug']);	}
require_once($head);
?>
<body>
<div class="page">
...
echo "<p><img src=\"/assets/images/ingredients/".$posting['ing_image']."\"/></p>";
}else{	
...
if ($res2['live']!==0){
echo "<p><img src=\"/assets/images/recipes/".$res2['rec_image']."\"/></p>";
break;
}
}
}
...
<h1>
<?php
echo ucwords($posting['ingredient']);
?>
</h1>
<?php
...
echo "
<p>I could talk a lot about ".$posting['ingredient']." here, but everybody knows what ".$posting['ingredient']." is, 
so I'm not going to waste anyone's time telling them things about ".$posting['ingredient'].".
<p>So I'll just leave you with all the recipes involving ".$posting['ingredient'].".
<p>Next time...... tips on hair re-growth and how to make millions out of crypto.</p>";
}
?>
</p>
<!--search section -->
