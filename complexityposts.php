...
if (isset($_GET['post-slug'])) {$postcom = getPost($_GET['post-slug']);	}
require_once($head);
?>
<body>
<div class="page">
...
if ($complex==="Simple") {
echo
"<p>Wham, bam, thank you mate! You want something quick and simple, ideally without having to get out of your pyjamas, right?
Either that or you just can't handle too much going on at once.  I know the feeling.</p>
<p>Just because you're not pushing the boat out doesn't mean you have to eat Pot Noodles though.  
Not that I have anything against Pot Noodles.  Oh no.</p>";
}
if ($complex==="Everyday") {
echo
"<p>Here is proof that to eat well does not mean you have to source vine leaves rolled on the hairy thighs of Greek maidens. </p>
<p>These recipes don't take too much work, but you can still eat well every day and have time left to watch Eastenders!</p>
<p>Although being frank... 'Awww Pat, what have you daahhhnn to me Pat....' etc.
<br>No seriously, I haven't watched it since Dennis died.</p>";
}
if ($complex==="Date night") {
echo
"<p>Sometimes knocking up a spag bol is not enough.  Sometimes food is about more than just eating.</p>
<p>Sometimes, you've got to get some.</p>
<p>These recipes are usually a bit more involved, and if you are cooking for that special someone 
it might be best to do some of the prep ahead of time, lest they fall asleep before it's ready.</p>
<p>In no way do I speak from experience.</p>";
}
if ($complex==="Masterchef") {
echo
"<p>And in the bluueeerr kichaaun we heerve Raaahlaaaand Cohhhhping... etc.</p>
<p>I luv a bit aaaaf craamble, yeeees ahhhh do a <a href=\"https://www.youtube.com/watch?v=OMg3epr53Ns\">baaahttry biscuit base</a>....etc.</p>
<p>If you're looking at these recipes, you might be trying too hard - either that or you're actually going on Masterchef.</p>";
}
